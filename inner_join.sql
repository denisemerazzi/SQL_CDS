...
# Verificando as opções da coluna status:
SELECT 
...
# 5. Gerar uma tabela de dados com 10 linhas, contendo o id do pedido, o estado e a cidade do cliente, o status do pedido,
...
# 6. Gerar uma tabela de dados com 70 linhas, contendo o id do pedido, o estado e a cidade do cliente, o status do pedido,
# o nome da categoria do produto, o preço do produto, a cidade e o estado do vendedor, a data de aprovação do
# pedido, tipo de pagamento e a nota de avaliação do produto, somente para os pedidos com a nota de avaliação do produto igual a 1
